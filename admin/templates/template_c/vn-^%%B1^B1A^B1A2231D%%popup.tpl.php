<?php /* Smarty version 2.6.30, created on 2026-02-08 14:36:36
         compiled from contact/popup.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'contact/popup.tpl', 53, false),)), $this); ?>
...
<tr>
   ...
   <td>
   <?php echo $this->_tpl_vars['edit']['name']; ?>
...
<tr>
   ...
   <td>
   <?php echo ((is_array($_tmp=$this->_tpl_vars['edit']['dated'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%H:%M:%S  %d-%m-%Y") : smarty_modifier_date_format($_tmp, "%H:%M:%S  %d-%m-%Y")); ?>
